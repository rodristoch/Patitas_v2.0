...
const userController = {
    ...
    processRegister: async (req, res) => {
        try {
            ...
            const usuarioCreado = await db.Usuario.create({
                ...
                imagen: req.file != undefined ? req.file.filename : "default.jpg",
        ...
        db.Usuario.update(
            {
                ...
                email: req.body.email,
                password: bcrypt.hashSync(req.body.password, 10),
                imagen: req.file != undefined ? req.file.filename : userToEdit.imagen,
    ...
    processEdit: async (req, res) => {
        try {
            ...
            userToEdit.imagen = req.file != undefined ? req.file.filename : userToEdit.imagen;
