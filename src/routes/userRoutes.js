...
const validaciones = [
    ...
    body("password").notEmpty().withMessage("Debes completar con una contraseña").bail().isLength({min: 5}).withMessage("La constraseña debe tener un min de 8 caracteres"),
    body("passwordrepeat").notEmpty().withMessage("Debes reingresar tu contraseña").bail().isLength({min: 5}).withMessage("La constraseña debe tener un min de 8 caracteres"),
...
const validacionesLogin = [
    ...
    body("password").notEmpty().withMessage("Ingresa tu contraseña").bail().isLength({min: 5}).withMessage("La constraseña debe tener un min de 8 caracteres")
]
...
router.put("/edit/:id", upload.single("imagen_user"), validaciones, userController.processEdit2);
