...
/* router.get('/perro/comida+promocion', productController.comidaPerroConPromo)  */
...
/* router.get('/perro/accesorios+promocion', productController.accesoriosPerroConPromo)  */
...
/* router.get('/perro/higiene+promocion', productController.higienePerroConPromo)  */
...
/* router.get('/perro/juguetes+promocion', productController.juguetesPerroConPromo)  */
...
/* router.get('/gato/comida+promocion', productController.comidaGatoConPromo)  */
...
/* router.get('/gato/accesorios+promocion', productController.accesoriosGatoConPromo) */ 
...
router.get('/comida', productController.comida)
router.get('/higiene', productController.higiene)
