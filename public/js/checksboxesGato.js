window.addEventListener("load", () => {
    ...
    let purina = document.querySelector("#purina")
    ...
    /* de marcas */
    let contenedorcheckboxCatit = document.querySelector(".lista_flexbox_desktop---checkboxCatitGato")
    let contenedorcheckboxCancat = document.querySelector(".lista_flexbox_desktop---checkboxCancatGato")
    let contenedorcheckboxPurina = document.querySelector(".lista_flexbox_desktop---checkboxPurinaGato")
    let contenedorcheckboxProPlan = document.querySelector(".lista_flexbox_desktop---checkboxProPlanGato")
    let contenedorcheckboxOtrasMarcas = document.querySelector(".lista_flexbox_desktop---checkboxOtrasMarcasGato")
    ...
    accesorios.addEventListener("click", () => {
        ...
        if(accesorios.checked){
            ...
            /* marcas */
            catit.disabled = true
            cancat.disabled = true
            purina.disabled = true
            ...
            cantidadProductos.innerHTML = "38 resultados"
            ...
            off.disabled = false
            /* marcas */
            catit.disabled = false
            cancat.disabled = false
            purina.disabled = false
    ...
    off.addEventListener && higiene.addEventListener("click", () => {
        ...
        if(off.checked && higiene.checked == false){
    ...
    off.addEventListener && juguetes.addEventListener("click", () => {
        ...
        if(off.checked && juguetes.checked == false){
    ...
    primerrango.addEventListener("click", () => {
        ...
        if(primerrango.checked){
            ...
            contenedorMenorPrecio.style.display = "none"
            contenedorMayorPrecio.style.display = "none"
            cantidadProductos.innerHTML = "6 resultados"  /* son 6 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
            ...
            contenedorVisible.style.display = "flex"
            contenedorprimero.style.display = "none"
            cantidadProductos.innerHTML = "38 resultados"  /* son 38 resultados */
            botonOrdenar.style.display = "flex"
            ordenar.style.display = "flex"
            flechitaAbajo.style.display = "flex"
            botonOrdenar.innerHTML = "Categoría"
    ...
    segundorango.addEventListener("click", () => {
        ...
        if(segundorango.checked){
            ...
            cantidadProductos.innerHTML = "15 resultados"  /* son 15 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
    ...
    cuartorango.addEventListener && comida.addEventListener("click", () => {
        ...
        if(cuartorango.checked && comida.checked == false){ /* SOLO 2do rango */
    ...
    cuartorango.addEventListener && higiene.addEventListener("click", () => {
        ...
        if(cuartorango.checked && higiene.checked == false){ /* SOLO 2do rango */
    ...
    cuartorango.addEventListener && juguetes.addEventListener("click", () => {
        ...
        if(cuartorango.checked && juguetes.checked == false){ /* SOLO 2do rango */
    ...
    catit.addEventListener("click", () => {
        ...
        if(catit.checked){
            ...
            contenedorMenorPrecio.style.display = "none"
            contenedorMayorPrecio.style.display = "none"
            contenedorcheckboxCatit.style.display = "flex"
            cantidadProductos.innerHTML = "1 resultados"
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            ...
            contenedorVisible.style.display = "flex"
            contenedorcheckboxCatit.style.display = "none"
            cantidadProductos.innerHTML = "38 resultados"
            botonOrdenar.style.display = "flex"
            ordenar.style.display = "flex"
            flechitaAbajo.style.display = "flex"
    ...
    cancat.addEventListener("click", () => {
        ...
        if(cancat.checked){
            ...
            contenedorMenorPrecio.style.display = "none"
            contenedorMayorPrecio.style.display = "none"
            contenedorcheckboxCancat.style.display = "flex"
            cantidadProductos.innerHTML = "2 resultados"
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            ...
            contenedorVisible.style.display = "flex"
            contenedorcheckboxCancat.style.display = "none"
            cantidadProductos.innerHTML = "38 resultados"
            botonOrdenar.style.display = "flex"
            ordenar.style.display = "flex"
            flechitaAbajo.style.display = "flex"
    ...
    purina.addEventListener("click", () => {
        ...
        if(purina.checked){
            ...
            contenedorMenorPrecio.style.display = "none"
            contenedorMayorPrecio.style.display = "none"
            contenedorcheckboxPurina.style.display = "flex"
            cantidadProductos.innerHTML = "1 resultados"
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            ...
            contenedorVisible.style.display = "flex"
            contenedorcheckboxPurina.style.display = "none"
            cantidadProductos.innerHTML = "38 resultados"
            botonOrdenar.style.display = "flex"
            ordenar.style.display = "flex"
            flechitaAbajo.style.display = "flex"
    ...
    otrasmarcas.addEventListener("click", () => {
        ...
        if(otrasmarcas.checked){
            ...
            cantidadProductos.innerHTML = "27 resultados"
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
    ...
    accesorios.addEventListener && off.addEventListener("click", () => {
        ...
        if(accesorios.checked && off.checked){  /* si comida y off estan chequeadas */
            ...
            tituloGato.innerText = "Accesorios Gato"  /* sigue siendo accesorio de gato */
            cantidadProductos.innerHTML = "2 resultados"  /* son 2 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
        ...
        } else if (accesorios.checked && off.checked == false){  /* si comida esta chequeada y off no */
            ...
            contenedorProdDescuentos.style.display = "none"  /* el contenedor dsctos NO */
            tituloGato.innerText = "Accesorios Gato"  /* sigue siendo comida de gato */
            cantidadProductos.innerHTML = "8 resultados"  /* son 8 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
    ...
    comida.addEventListener && off.addEventListener("click", () => {
        ...
        if(comida.checked && off.checked){  /* si comida y off estan chequeadas */
            ...
            contenedorProdDescuentos.style.display = "none"  /* el contenedor dsctos NO */
            tituloGato.innerText = "Comida Gato"  /* sigue siendo comida de gato */
    ...
    higiene.addEventListener && off.addEventListener("click", () => {
        ...
        if(higiene.checked && off.checked){  /* si comida y off estan chequeadas */
            ...
            contenedorProdDescuentos.style.display = "none"  /* el contenedor dsctos NO */
            tituloGato.innerText = "Higiene Gato"  /* sigue siendo higiene de gato */
            cantidadProductos.innerHTML = "3 resultados"  /* son 3 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
        ...
        } else if (higiene.checked && off.checked == false){  /* si comida esta chequeada y off no */
    ...
    juguetes.addEventListener && off.addEventListener("click", () => {
        ...
        if(juguetes.checked && off.checked){  /* si comida y off estan chequeadas */
            ...
            contenedorProdDescuentos.style.display = "none"  /* el contenedor dsctos NO */
            tituloGato.innerText = "Juguetes Gato"  /* sigue siendo juguetes de gato */
            cantidadProductos.innerHTML = "2 resultados"  /* son 2 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
        ...
        } else if (juguetes.checked && off.checked == false){  /* si comida esta chequeada y off no */
            ...
            contenedorProdDescuentos.style.display = "none"  /* el contenedor dsctos NO */
            tituloGato.innerText = "Juguetes Gato"  /* sigue siendo juguetes de gato */
            cantidadProductos.innerHTML = "9 resultados"  /* son 9 resultados */
            botonOrdenar.style.display = "none"
            ordenar.style.display = "none"
            flechitaAbajo.style.display = "none"
            divOpciones.style.opacity = "0"
