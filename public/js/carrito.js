...
window.addEventListener("load", () => {
    ...
    let botonAgregarConAuth2 = document.querySelectorAll(".boton_agregarConAuth2") /* el boton de agregar al carrito en detalle.ejs CON AUTH */
    let botonComprarConAuth2 = document.querySelectorAll(".boton_comprarConAuth2") /* el boton de comprar ahora en detalle.ejs CON AUTH */
    ...
    botonAgregarConAuth2.forEach((bot) => {
        bot.addEventListener("click", (e) => {
    ...
    botonComprarConAuth2.forEach((bot) => {
        bot.addEventListener("click", (e) => {
